...
<head>
  <meta charset="utf-8">
  <title>Oxygym+</title>
  <script type="text/javascript" src="controlclient.js"></script>
		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">S'inscrire</li>
				</ol>
			</nav>
		</div>
...
<form name="f1" method="POST" action="ajouterclient.php" >
		...
		<div class="row">
			<div class="col-md-7">
				...
				<div>
					<?php
					if(isset($_GET['error'])) {
					?> <h5 style="color:#f55;">remplir tous les champs</h5> <?php }
					?>
				</div>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input class="form-control" name="mdp" id="mdp" placeholder="Votre Mot de passe" type="password">
					</div>
