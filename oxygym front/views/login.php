...
header('Location: '.($_SESSION["role"] == "user" ? 'b.html' : '../../oxygym admin/views/GestionClient.php'));
} else {
...
<?php
	...
	?>
	<a class="nav-link" href="inscription.php">SIGN UP</a></a>
	<?php
}
?>
</li>
...
<section id="main-container">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" email" name="user_name">
