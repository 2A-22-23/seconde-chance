    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Gestions Salles</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form method="get" action="gestions salles.php">
...
$salle1C=new salleC();
if (isset($_GET['key'])) {
        $listesalles = $salle1C->rechercheSalle($_GET['key']);
    } else 
$listesalles=$salle1C->AfficherSalle() ;
?>
...
foreach($listesalles as $row)
{
  ...
  <td><form method="GET" action="supprimersalle.php">
  <input type="submit" name="supprimer" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['num']; ?>" name="num">
  </form>
  </td>

 <td><a href="modifierSalle.php?num=<?PHP echo $row['num']; ?>">
  Modifier</a></td>
  </tr>
  <?PHP
}
?>
                ...
                <div>
                  <!--<form method="POST" action="pdf_ahmed.php">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold">Ajouter Salle</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body mx-3">
                        <form method="GET" action="AjouterSalle.php">
                          <table>
                            <tr>
                              <td>
                            ...
                            <tr>
                                <td>
                                    <label>Numero de la salle</label></td>
                            ...
                            <tr>
                                <td>
                                    <label for="description">les détails de ce type de sport ?</label>
                                  </td>
