    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Gestions Abonnements</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                $listabonnement=$abonnementC->afficher_return();
                ?>
               <form name="form" method="POST">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <tr>
                   ...
                   <?php
                   while($donne=$listabonnement->fetch())
                   {
                    ?>
                     <tr>
                     <td><?php echo $donne['ida'];?></td>
                     <td><?php echo $donne['nom'];?></td>
                     <td><?php echo $donne['prenom'];?></td>
                     <td><?php echo $donne['age'];?></td>
                     <td><?php echo $donne['dateD'];?></td>
                     <td><?php echo $donne['dateF'];?></td>
                     <td>
                       <a href="modifierabonn.php?ida=<?php echo $donne['ida'];?>">modifier</a>
                     </td>
                     <td><form method="POST" action="supprimerabonn.php">
                      <input type="submit" name="sup" value="supprimer">
                      <input type="hidden" name="ida" value="<?php echo $donne['ida'];?>">
                    </form></td>
            ...
            <form method="POST" action="pdf1.php">
               ...
               <form method="POST" action="rechercherabonn.php">
              <div>
