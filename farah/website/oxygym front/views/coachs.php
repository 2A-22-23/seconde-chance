...
<style>
	...
	background:linear-gradient(to bottom, #f9f9f9 5%, #f06060 100%);
...
.myButton:hover {
	background:linear-gradient(to bottom, #f06060 5%, #f9f9f9 100%);
...
.myButton:active {
  ...
  <link href="cours.css" rel="stylesheet">
		...
		<nav class="navbar navbar-expand-lg navbar-dark">
			...
			<div class="collapse navbar-collapse text-center" id="navigation">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="salle.php">Nos Salles</a></a>
					</li>
					<!--<li class="nav-item">
...
<section id="main-container">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
	  ...
	  <a href="topcoachexp.php" class="nav-link">Top Experience</a>
      </li>
      <li class="nav-item">
	  <a href="topcoachage.php" class="nav-link">Top Age</a> 
      </li>
      <li class="nav-item">
	  <a href="topcoachsalaire.php"class="nav-link">Top Salaire</a>
	  </li>
	 
      
	
	<form   method="POST" action="coach_recherche.php"class="form-inline">
	<input class="form-control mr-sm-2" type="search" placeholder="Chercher Par Nom" aria-label="Search" name="rechercher">
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Chercher</button>
  </form>
  <li class="nav-item">
	  <a href="tri_experience.php"class="nav-link">Tri Par Experience</a>
	  </li>
	  <li class="nav-item">
	  <a href="tri_age.php"class="nav-link">Tri Par Age</a>
	  </li>	
	  <li class="nav-item">
	  <a href="tri_salaire.php"class="nav-link">Tri Par Salaire</a>
      </li>  
  </ul>
  </div>
</nav>
