...
$listeCoach=$coach1C->rechercherCoach_parnom($_POST['rechercher']);
$recherche_nom=$_POST['rechercher'];
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 heading">
				...
				<h2 class="title classic"><?PHP echo $recherche_nom?></h2>
			</div>
		</div>
