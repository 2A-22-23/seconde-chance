		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Nos Cours</li>
				</ol>
			</nav>
		</div>
...
<section id="main-container">
	<div class="container">
		<div class="row">
			<div class="col-md-12 heading">
				...
				<h2 class="title classic">Nos Cours</h2>
			</div>
		</div>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
	  ...
	  <a href="zumba.php" class="nav-link">Zumba</a>
      </li>
      <li class="nav-item">
	  <a href="dance.php" class="nav-link">Dance</a> 
      </li>
      <li class="nav-item">
	  <a href="spinning.php"class="nav-link">Spinning</a>
	  </li>
	  <li class="nav-item">
	  <a href="musculation.php"class="nav-link">Musculation</a>
	  </li>
	  <li class="nav-item">
	...
	<form   method="POST" action="cours_recherche.php"class="form-inline">
	<input class="form-control mr-sm-2" type="search" placeholder="Chercher Par Nom" aria-label="Search" name="recherche">
	...
	foreach($listeCours as $row){
		...
		<div class="col-md-3">
				<div class="team wow slideInLeft">
					...
					<img src="images/cours/<?PHP echo $row['image']; ?>" alt="">
