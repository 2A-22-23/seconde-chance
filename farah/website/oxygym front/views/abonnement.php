	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
				<div class="plan text-center">
					...
					<a class="btn btn-primary" href="formabonn.php">Commander</a>
				</div>
			</div><!-- plan end -->
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
				<div class="plan text-center">
					<span class="plan-name">BASIQUE <small>(Par mois)</small></span>
					<p class="plan-price"><sup class="currency">DT</sup><strong>110</strong><sub>.00</sub></p>
					<ul class="list-unstyled">
						<li>Musculation</li>
						<li>Cardio</li>
						<li>Aérobique ou Zumba</li>
						<!--<li>SSL Shopping Cart</li>
						<li>24/7 Live Support</li>-->
					</ul>
					<a class="btn btn-primary" href="formabonn.html">Commander</a>
			...
			<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1s">
				<div class="plan text-center">
					<span class="plan-name">ULTRA<small>(Par mois)</small></span>
					<p class="plan-price"><sup class="currency">DT</sup><strong>160</strong><sub>.00</sub></p>
					<ul class="list-unstyled">
						<li>Aérobique</li>
						<li>Cardio</li>
						<li>Spinning</li>
						<li>Zumba ou Dance Orientale</li>
						<!--<li>24/7 Live Support</li>-->
					</ul>
					<a class="btn btn-primary" href="formabonn.html">Commander</a>
				</div>
			...
			<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1.4s">
				<div class="plan text-center featured">
					<span class="plan-name">ELITE<small>(Par mois)</small></span>
					<p class="plan-price"><sup class="currency">DT</sup><strong>220</strong><sub>.00</sub></p>
					<ul class="list-unstyled">
						<li>Musculation</li>
						<li>cardio</li>
						<li>Aérobique</li>
	      ...
	      <div class="col-md-12 text-center">
	        <ul class="footer-social unstyled">
	          <li>
	            ...
	            <a title="Google+" href="http://oxygymplus.tn/">
