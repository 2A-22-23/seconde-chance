			...
			<div class="col-md-7">
				<form id="contact-form" action="contact-form.php" method="post" role="form">
					...
					<div class="text-right"><br>
						...
						<a class="btn btn-primary solid blank" href="index.php"> send message </a>
					</div>
				</form>
			</div>
			<div class="col-md-5">
	    ...
	    <div class="row">
	      <div class="col-md-12 text-center">
	        <div class="copyright-info">
	          &copy;  2023 Themefisher. <span>Designed by <a
	              href="https://themefisher.com">khaled cheour</a></span>
	        </div>
	      </div>
	    </div>
	    <!--/ Row end -->
