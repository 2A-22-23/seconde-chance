	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 heading">
				...
				<h2 class="title classic">Nos salles</h2>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="team wow slideInLeft">
					<div class="img-hexagon">
						<img src="images/salle1/<?PHP echo $row['image_salle']; ?>" alt="">
					...
					<div class="team-content">
                            <p> Numero<h3><?PHP echo $row['num']; ?></h3></p>
                            <p>Categorie:  <?PHP echo $row['categorie']; ?></p>
                            <p>Age:  <?PHP echo $row['coach']; ?>ANS</p>
							<p> <?PHP echo $row['description']; ?>ANS</p>
