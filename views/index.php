...
<section id="home" class="p-0">
	<div id="main-slide" class="cd-hero">
		<ul class="cd-hero-slider">
			<li class="selected">
				<div class="overlay2">
					<img class="" src="images/slider/bg11.jpg" alt="slider">
				</div>
				<div class="cd-full-width">
					<h2>Bienvenue ! </h2>
					<h3>Bienvenue à GYMNATION</h3>
	    ...
	    <div class="row">
	      <div class="col-md-12 text-center">
	        <div class="copyright-info">
	          &copy; design 2023 esprit. <span>Designed by <a
	              href="https://www.facebook.com/khaled.cheour.980/">khaled cheour</a></span>
	        </div>
	      </div>
	    </div>
	    <!--/ Row end -->
